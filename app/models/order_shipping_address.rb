class OrderShippingAddress
  ...
  attr_accessor :postal_code, :prefecture, :city, :addresses, :building, :phone_number, :user_id, :item_id, :created_at
  ...
  def save
    order = Order.create(user_id: user_id, item_id: item_id, created_at: created_at)
